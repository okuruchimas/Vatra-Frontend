...
export const BlackGradient = styled.img<BlackGradientsProps>`
  ...
  //gradient animation
  -moz-animation: ${({ animationTime, turnLeft }) => (`${turnLeft ? "infinity-rotate-l" : "infinity-rotate-r"} ${animationTime}s linear infinite`)};
  -webkit-animation: ${({ animationTime, turnLeft }) => (`${turnLeft ? "infinity-rotate-l" : "infinity-rotate-r"} ${animationTime}s linear infinite`)};
  animation: ${({ animationTime, turnLeft }) => (`${turnLeft ? "infinity-rotate-l" : "infinity-rotate-r"} ${animationTime}s linear infinite`)};
